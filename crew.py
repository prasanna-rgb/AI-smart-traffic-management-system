...
class SmartTrafficCrew:
    ...
    def run(self, telemetry_input: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logger.info(f"Pipeline complete for {road_name}. Congestion Score: {c_pred.get('congestion_score')}")
        return report_dict

    def _run_rule_based_flow(self, telemetry: Dict[str, Any]) -> Dict[str, Any]:
        """Execute high-speed deterministic workflow across all 7 agents."""
