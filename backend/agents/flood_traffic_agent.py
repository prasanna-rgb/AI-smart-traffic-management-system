"""
Flood & Waterlogging Traffic Agent (Backend Package).
"""
...
from backend.tools.flood_data_tools import evaluate_flood_and_waterlogging_tool, FloodRiskCalculator


logger = logging.getLogger("smart_traffic_ai.backend.agents.flood")
